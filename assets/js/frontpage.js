    ...
    return data.projects
      ...
      .map(project => {
        return `
                ...
                <img src="${project.screenshotUri}" alt="${
          project.title
        }"></a> <br>
                <div>
                ...
                <div>
                    <small>
                        <a class="text-link"  href="${
                          project.projectUri
                        }" target="_blank"><i class="fas fa-globe-europe"></i> Live Project</a><br>
                        ${
                          project.githubUri != undefined
                            ? `<a class="text-link"  href="${
                                project.githubUri
                              }" target="_blank"><i class="fab fa-github"></i> Code on GitHub</a>`
                            : ``
                        }
                    </small>
                </div>   
...
const projectList = new showProjectList(
